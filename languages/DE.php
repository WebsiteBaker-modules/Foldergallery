...
$MOD_FOLDERGALLERY['REDIRECT']          = 'Sie m&uuml;ssen zuerst die <a href="{{SETTING_LINK}}">Grundeinstellungen</a> vornehmen. '
...
$MOD_FOLDERGALLERY['DELETE_IMG_ARE_YOU_SURE']   = 'Sind Sie sicher, dass Sie das ausgew&auml;hlte Bild, Titel, Beschreibung l&ouml;schen m&ouml;chten? Die Datei wird komplett vom Server gelöscht!';
$MOD_FOLDERGALLERY['DELETE_CAT_ARE_YOU_SURE']   = 'Sind Sie sicher, dass Sie die ausgew&auml;hlte Kategorie, Unterkategorien und Bilder, Titel, Beschreibungen l&ouml;schen m&ouml;chten? Die Dateien werden komplett vom Server gelöscht!';
