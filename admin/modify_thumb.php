...
if (isset($aRequestVars['id']) && is_numeric($aRequestVars['id']))
{
    ...
    if ($query = $database->query($sql)) {
        ...
        $full_file_link = $root_dir.$parent . '/' . $bildfilename;
...
/*
                ...
                $iPreviewRatio = $previewWidth/$previewHeight;
*/
            ...
            $t->set_var(array(
                ...
                'FULL_FILE_LINK'    => $url.MEDIA_DIRECTORY.$full_file_link,
                'REL_FILE_LINK'     => $full_file_link,
